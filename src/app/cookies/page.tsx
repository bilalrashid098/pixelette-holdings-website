    ...
    <>
      ...
      <Section>
        <div style={{ maxWidth: 860 }} className="prose">
          <h2 style={{ fontSize: '1.6rem', marginTop: 10 }}>The short version</h2>
          <p>
          ...
          <h2 style={{ fontSize: '1.6rem', marginTop: 44 }}>If that changes</h2>
          <p>
          ...
          <h2 style={{ fontSize: '1.6rem', marginTop: 44 }}>Who we are</h2>
          <p>
